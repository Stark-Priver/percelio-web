      ...
      <section className="pt-32 pb-20 container-px max-content">
        <div className="max-w-3xl">
          ...
          <p className="text-lg text-[var(--muted)] mb-10 leading-relaxed">
            Custom-built logistics infrastructure for global organizations. We provide the security, scalability, and integration capabilities required by large-scale enterprises.
          </p>

          <div className="grid gap-4 mb-12">
            {[
              'Enterprise-grade security and compliance (GDPR/ISO)',
              'Advanced API integrations and webhooks',
              'SLA-backed priority support 24/7/365',
