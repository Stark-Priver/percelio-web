...
export default function Testimonials() {
  const testimonials = [
    {
      quote: "Pacelio transformed how we handle deliveries. Our customers now track orders in real time and we've reduced 'where is my order' calls by 80%. It's built for how business actually works in Tanzania.",
      name: "Amina Saleh",
      title: "Operations Manager",
      company: "Saleh Trading Co., Mbeya",
      initials: "AS",
      stars: 5,
    },
    {
    ...
    {
      quote: "We integrated Pacelio into our fleet operations within a week. The SLA tracking alone saved us three client disputes in the first month. The analytics dashboard is genuinely impressive.",
      name: "Fatuma Osei",
      title: "CEO",
      ...
      <div className="max-content container-px relative z-10">
        ...
        <div className="text-center mb-16 reveal">
          ...
          <p className="text-lg text-white/50 max-w-xl mx-auto leading-relaxed">
            From small traders to large logistics fleets — Pacelio delivers results that matter.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {testimonials.map((t, i) => (
            <div key={i} className="bg-[var(--orange-tint)] rounded-[2rem] p-10 flex flex-col relative overflow-hidden group hover:scale-[1.02] transition-transform duration-300">
              ...
              <p className="text-lg text-[var(--foreground)] font-medium leading-relaxed mb-10 flex-1">
                &ldquo;{t.quote}&rdquo;
              </p>
              ...
              <div className="flex items-center gap-4 pt-8 border-t border-[var(--orange)]/10">
                ...
                <div>
                  ...
                  <div className="text-xs text-[var(--muted)] font-medium mt-0.5">{t.title} · {t.company}</div>
                </div>
              </div>
            </div>
          ))}
